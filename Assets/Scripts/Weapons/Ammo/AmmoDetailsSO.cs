...
public class AmmoDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Populate with the prefab to be used for the ammo. If multiple prefabs are specified then a random rpefab from teh array will be selected." +
    ...
    #endregion
    #region Tooltip
    [Tooltip("This is the minimum number of ammo that are spawned per show. A random number of ammo are spawned between the minimum and maximum values.")]
    #endregion
    public int ammoSpawnAmountMin = 1;
    #region Tooltip
    [Tooltip("This is the maximum number of ammo that are spawned per show. A random number of ammo are spawned between the minimum and maximum values.")]
    #endregion
