...
public class SoundEffectSO : ScriptableObject
{
    ...
    [Tooltip("The minimum pitch variation for the sound effect. A random pitch variation will be generated between the minimum and maximum values. " +
        "A random pitch variation makes sound effect sound more natural.")]
    #endregion
    [Range(0.1f, 1.5f)]
    public float soundEffectPitchRandomVariationMin = 0.8f;
    #region Tooltip
    [Tooltip("The maximum pitch variation for the sound effect. A random variation will generated between the minimum and maximum values. " +
