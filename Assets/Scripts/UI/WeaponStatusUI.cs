...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    #region Tooltip
    [Tooltip("Populate with the TextMeshPro-Text component on the child AmmoRemaining gameobject")]
    #endregion
    ...
    private void OnEnable()
    {
        ...
        player.weaponReloadedEvent.OnWeaponReload += WeaponReloadedEvent_OnWeaponReloaded;
    }
