...
public class PlayerControl : MonoBehaviour
{
    ...
    {
        // Switch weapon if mouse scroll wheel is selected
    ...
    private void ReloadWeaponInput()
    {
        ...
        // If ammo in the clip equals clip capacity then return
    ...
    private void SetCurrentWeaponToFirstInTheList()
    {
        ...
        // Loop through the existing weapon list and add - skipping the current weapon
        int index = 2;
